...
This repository is a living methodology. Improve foundations carefully (see [`assets/improvements.md`](assets/improvements.md)); add case studies under `case-study/` without overwriting the ChangePool example unless intentional.
