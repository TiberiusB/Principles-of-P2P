...
| **Contribution Logging & Attribution**   | The degree to which contribution of peers is recorded, credited, and visible.                                         | Attribution builds trust, encourages participation, helps with reward / reputation systems. Without it, contributions may be invisible or unfairly taken.                            | Is there a contribution tracking system? How granular is it (small contributions vs just big ones)? Is attribution used in reward / reputation? Is historical contribution preserved across changes / forks / reorganizations? Are non-technical / less visible contributions recognized? Do contributors feel seen in everyday practice? | 0 little or no attribution; mostly informal or verbal recognition; many invisible contributions. 5 detailed, persistent record; wide types of contributions; used in reputation / reward; non-technical contributions visible. |
...
| **Contextual & Ecological Embeddedness** | Degree to which the organization recognizes local context and cosmo-local principles (share knowledge globally, produce locally), and respects ecological / biophysical limits. | P2P systems are autonomy–dependence systems: they depend on ecological and cultural environments; ignoring locality and ecology undermines long-term commons stewardship (see `Model.md`, principle of Contextual Embeddedness). | Evidence of cosmo-local practice (global design commons, local production). Disclosure or accounting of ecological costs (energy, hosting, travel). Efforts to reduce duplication across the ecosystem. Biophysical constraints acknowledged in strategy and design. | 0 blind to context and ecology; global abstraction with no local grounding. 5 strong cosmo-local practice; ecological costs transparent; design respects biophysical limits. |
...
- Mark a cell `NE` (not evidenced) when evidence was sought but not found, and `N/A` when a level is out of scope for the organization; exclude both from averages. Reserve 0 for evidence of absence or contrary practice — absence of evidence is not evidence of absence.
...
- Participant narratives and experiential surveys: lived sense of agency, recognition, and meaning.  
...
| Project level / Phenomenology | Phenomenological Grounding   | 2           | Surveys show low felt agency despite open documentation; recognition feels uneven. |
| ...                           | ...                          | ...         | ...                                                                                |
