...
- Run parallel searches across:
  ...
  - GitHub org (repos, LICENSE, CONTRIBUTING, governance files)
  - Voting portals (Snapshot/Tally), foundation filings, whitepapers
...
- Main site: {{MAIN_SITE}}
- Voting portals: Snapshot {{SNAPSHOT_SPACE}}, Tally {{TALLY_SPACE}}
...
For each dimension below, record: Findings + Citations.
...
- Findings:
  - Legal entities (foundation/association/co-op), jurisdiction, responsibilities (compliance, banking)
- Citations:
  - 

### 1.6 Infrastructure & Commons
- Findings:
  - OSS footprint (repos), license posture, shared infra/standards
- Citations:
  - 
...
- Findings:
  - Code and non-code attribution; contribution accounting systems
- Citations:
  - 

### 2.4 Conflict Management & Forking
- Findings:
  - Repo license types, trademark/brand policy for forks/naming; notable forks
- Citations:
  - 
...
- Findings:
  - Declared values/mission; evidence of alignment in actions
- Citations:
  - 

### 4.2 Learning, Adaptation & Innovation
- Findings:
  - Evidence of iteration, postmortems/maturity frameworks; changes over time
- Citations:
  - 
