...
- `{{ORG_NAME}}_compilation.md` (from template): dynamic profile, scores, averages, path-dependency analysis, stress tests, scenario recommendations, X-ray, ethos, conclusion.
